        ...
        <FadeIn>
          ...
          {events.length > 0 ? (
            ...
            <div className="rounded-3xl bg-card border border-border p-12 text-center">
              <h3 className="font-heading text-2xl font-semibold text-offwhite mb-2">No events yet</h3>
              <p className="text-muted-foreground">We&apos;ll post tastings, festivals and meetups here when they&apos;re scheduled.</p>
            </div>
          )}
        </FadeIn>
      </div>
